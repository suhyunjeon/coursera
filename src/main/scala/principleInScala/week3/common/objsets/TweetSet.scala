package principleInScala.week3.common.objsets
...
class Empty extends TweetSet {
  ...
  override def head: Tweet = throw new Exception("Empty.head")

  override def tail: TweetSet = throw new Exception("Empty.tail")
}
